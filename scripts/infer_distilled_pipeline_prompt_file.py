...
def main() -> None:
    ...
    parser.add_argument("--distilled-checkpoint", default="checkpoints/ltx-2.3-22b-distilled-1.1.safetensors")
    parser.add_argument("--gemma-root", default="checkpoints/gemma")
    parser.add_argument("--spatial-upsampler", default="checkpoints/ltx-2.3-spatial-upscaler-x2-1.1.safetensors")
